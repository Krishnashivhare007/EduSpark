  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-100 to-gray-200 px-6 py-8">
      <motion.header
        ...
        className="mb-10 rounded-2xl bg-black/80 backdrop-blur-xl border border-white/10 px-8 py-6 shadow-[0_10px_15px_rgba(0,0,0,0.5)] items-start flex md:items-center justify-between gap-4 flex-col md:flex-row"
      >
     ...
     className="flex flex-col lg:grid-cols-4 gap-6">
