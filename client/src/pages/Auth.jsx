  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-black px-8">
      <motion.header
        ...
        className="max-w-7xl mask-auto mt-8 rounded-2xl bg-black/80 backdrop-blur-xl border border-white/10 px-8 py-6 shadow-[0_10px_15px_rgba(0,0,0,0.5)]"
      >
      ...
      <main className="max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            ...
            <Feature icon="📊" title="Charts & Graphs" des="Auto-generated diagrams, graphs and flow charts."/>
...
function Feature({icon, title,des}){
    return(
        ...
        transition={{type:"spring",stiffness:200,damping:18}}
        className="relative rounded-2xl p-6 bg-linear-to-br from-black/90 via-black/80 to-black/90 backdrop-blur-2xl border border-white/10 shadow-[0_10px_20px_rgba(0,0,0,0.7)] text-white"
