...
import ReCharSetup from "./ReChartSetup";
...
function FinalResult({ result }) {
  ...
  return (
    <div className="mt-6 p-3 space-y-10 bg-white">
      ...
      {quickRevision && (
        <section className="rounded-xl bg-linear-to-r from-green-100 to-green-50 border border-gray-200 p-6">
      ...
      {result.charts?.length > 0 && (
        <section>
          ...
          <ReCharSetup charts={result.charts} />
          <p className="mt-3 text-xs text-gray-500 italic">
