...
function Footer() {
  return (
    <motion.div
      ...
      className="z-10 mx-6 mb-6 mt-24 rounded-2xl bg-linear-to-br from-black/90 via-black/80 to-black/90 backdrop-blur-2xl border border-white/10 px-8 py-8 shadow-[0_10px_20px_rgba(0,0,0,0.5)]"
    >
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
        ...
        >
          ...
          <p className="text-sm text-gray-300 max-w-sm">
            EduSpark AI helps students generate exam-focused notes, revision
