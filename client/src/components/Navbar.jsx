...
function Navbar() {
    ...
    return ( 
        ...
        className="relative z-20 mx-6 mt-6 rounded-2xl bg-linear-to-br from-black/90 via-black/80 to-black/90 backdrop-blur-2xl border border-white/10 shadow-[0_12px_25px_rgba(0,0,0,0.45)] flex items-center justify-between px-8 py-4">

        <div className="flex items-center gap-3">
            <img src={logo} alt="ExamNotes" className="w-9 h-9"/>
            <span className="text-lg hidden md:block font-semibold text-white">
                EduSpark <span className="text-gray-400">AI</span>
            </span>
        </div>
        ...
        <div className="relative">
            ...
            className="absolute -right-12.5 mt-4 w-64 rounded-2xl bg-black/90 backdrop-blur-xl border border-white/10 shadow-[0_5px_10px_rgba(0,0,0,0.5)] p-4 text-white">
